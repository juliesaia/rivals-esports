...
INSERT INTO "new_Set" ("fullRoundText", "id", "loserGameCount", "loserid", "order", "phase", "smashggid", "tournamentid", "uf", "winnerGameCount", "winnerid") SELECT "fullRoundText", "id", "loserGameCount", "loserid", "order", "phase", "smashggid", "tournamentid", "uf", "winnerGameCount", "winnerid" FROM "Set";
DROP TABLE "Set";
