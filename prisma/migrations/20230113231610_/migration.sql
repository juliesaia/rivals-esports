...
CREATE TABLE "new_Accolade" (
    ...
    CONSTRAINT "Accolade_setid_fkey" FOREIGN KEY ("setid") REFERENCES "Set" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_Accolade" ("count", "description", "id", "leagueid", "opponentid", "playerid", "rarity", "shortName", "title", "tournamentid", "type") SELECT "count", "description", "id", "leagueid", "opponentid", "playerid", "rarity", "shortName", "title", "tournamentid", "type" FROM "Accolade";
DROP TABLE "Accolade";
