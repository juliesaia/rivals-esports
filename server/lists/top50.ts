export const top50 = {
    ...
    season5: [
        ...
        },
        {
            ...
            ranking: 9,
            char: "kragg",
            blurb: "Sqaunto leaps onto the RCS Top 50 with three consecutive Top 8 placements to start off the season. As the highest ranked solo Ranno on the Top 50, Squanto placed in the Top 8 of every single ROCS event and Elemental Major that he entered, only breaking that streak in the RCS Finals. Squanto tallied wins against the likes of ZeeBee and CakeAssault while only losing a single set to players ranked below him.",
        },
        {
            name: "Halite",
            smashggID: "b06f1d29",
